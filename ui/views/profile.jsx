  ...
  render() {
    return <div className="toolbar">
      <div className="toolbar-inner">
        ...
        <DropdownSelectorBtn className="btn toolbar-btn" items={VIEW_OPTS} initValue="messages" label="View" />
...
export default class Profile extends React.Component {
  render() {
    ...
    const filter = msg => !!findLink(mlib.links(msg.value.content.recps), id)
